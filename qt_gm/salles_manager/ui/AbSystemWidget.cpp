...
const QColor cMur(0x18, 0x21, 0x32);
const QColor cMurBord(0x2B, 0x37, 0x50);
const QColor cPassage(0x11, 0x17, 0x25);
const QColor cPassageBord(0x1E, 0x29, 0x3D);
const QColor cInactif(0x35, 0x45, 0x63);
const QColor cVert(0x10, 0xB9, 0x81);
const QColor cOrange(0xF5, 0x9E, 0x0B);
const QColor cGrisBadge(0x6E, 0x76, 0x81);
}
